...
Example size & Security Parameter & Their time & Our time & ? \\ \hline
Toy & 42 & & &  \\ \hline
Small & 52 & & &  \\ \hline
Medium & 62 & & &  \\ \hline
Large & 72 & & &  \\ \hline
...
\end{center}
\caption{A comparison of performance for the Coron et al. implementation and our LWE-based implementation}
\end{figure}
